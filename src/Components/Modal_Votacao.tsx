...
import { X, MessageSquare, Info, ClipboardList } from 'lucide-react';
...
const ModalVot: React.FC<ModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
            {/* Container do Modal */}
            <div
                className="bg-white rounded-xl shadow-2xl max-w-xl w-full m-4 transform transition-all"
            ...
            >
                ...
                <div className="p-6 space-y-6">
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center space-x-2 text-blue-600 font-medium pb-2">
                        ...
                        <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
                            <div className="flex-1">
                                ...
                                <select
                                    id="categoria"
                                    className="w-full p-2 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 appearance-none transition duration-150"
                                    required
                                >
                ...
                <div className="flex justify-end space-x-3 p-4 border-t border-gray-100">
                    ...
                    <button
                        type="submit"
                        className="flex items-center space-x-2 px-6 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-150 shadow-md shadow-blue-500/50"
                    >
                        <svg
